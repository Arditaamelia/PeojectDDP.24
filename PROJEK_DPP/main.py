...
def Send():
    ...
    def sender():
        ...
        conn.send(file_data)
        print("Data has been trnasmitted succesfully....")
...
def Receive():
    ...
    rr=Button(main,text="Receiver",compound=LEFT,image=imageicon,width=130,bg="#39c790",font="arial 14 bold",command=receiver)
    rr.place(x=20,y=500)
